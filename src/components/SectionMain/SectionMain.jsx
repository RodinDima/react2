      ...
      <main className="main">
        ...
        <div className="main__container">
          <div className="main__content">
              ...
              <h3 className="main__title title"><span><TextTemplate className="firstStroke" text="What we do" /> </span><span className='title-after'>to grow your <span className='lastWord'>Busines</span> <TextTemplate/></span></h3> 
