    ...
    <section className='reviews'>
      <div className="reviews__container">
        <div className="reviews__content">
          <h3 className='work__title'><span><TextTemplate className="busines__firstStroke" text="Our Testimonials" /> </span><br /><span className='business__title-after'>What Our Clients Are  <span className='lastWord-mod'>Saying</span></span></h3>
