    ...
    <section className='work'>
      ...
      <div className="work__container">
        <div className="work__content">
          ...
          <h3 className='work__title'><span><TextTemplate className="busines__firstStroke" text="Our Recent Work" /> </span><br /><span className='business__title-after'>By Our <span className='lastWord-mod'>Experts</span></span></h3>
